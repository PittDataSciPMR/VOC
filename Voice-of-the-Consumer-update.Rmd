...
# Summary of xtics in those with multiple conditions
```{r}
...
# Summary in those with single conditions
...
# Counts of people in each category of disablity type
```{r}
...
# Table 1. Demographic Characteristics (ignore multiple response)
```{r}
